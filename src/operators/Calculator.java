...
public class Calculator {
    ...
    public static void main() {
        ...
        switch(op){
            case 0: System.out.println(n1+"+"+n2+"="+(n1+n2));break;
            case 1: System.out.println(n1+"-"+n2+"="+(n1-n2));break;
            case 2: System.out.println(n1+"*"+n2+"="+(n1*n2));break;
            case 3: if(n2!=0)System.out.println(n1+"/"+n2+"="+(n1/n2));
                    else System.out.println("Erroare impartire la zero");break;
            case 4: System.out.println(n1+"^"+n2+"="+Math.pow(n1,n2));break;
        }
